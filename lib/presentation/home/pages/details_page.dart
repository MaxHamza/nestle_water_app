    ...
    return Scaffold(
        ...
        body: Container(
          padding: EdgeInsets.only(
              right: width * 0.04, left: width * 0.04, top: height * 0.05),
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          state.offer[widget.index].title,
                        ...
                        Align(
                          ...
                          child: Text(
                            '${state.offer[widget.index].price.toString()} ل.س',
                        ...
                        Text(
                          state.offer[widget.index].description,
                        ...
                        Align(
                          alignment: Alignment.topRight,
                          child: Text(
                            state.offer[widget.index].company['name'],
                            style: TextStyle(color: primaryColor),
                          ),
                        ),
                        SizedBox(
                        ...
                        Align(
                          alignment: Alignment.topRight,
                          child: Text(
                              state.offer[widget.index].company['description']),
                        ),
                        SizedBox(
                          height: height * 0.1,
                        ),
                        ...
                        MaterialButton(
                          onPressed: () {
                            var newItem = CartItem(
                                ...
                                title: state.offer[widget.index].title,
                                description:
                                    state.offer[widget.index].description,
                                index: widget.index,
                                price: state.offer[widget.index].price);
                            BlocProvider.of<MyCartCubit>(context)
                                .addToCart(newItem, quantity: widget.quantity);
                            BlocProvider.of<MyCartCubit>(context).loadCart();
                            ScaffoldMessenger.of(context).showSnackBar(const
                                SnackBar(content: Text('تمت الاضافة بنجاح'),backgroundColor: Colors.green,duration: Duration(seconds: 1),));
                          },
                          color: Colors.white,
                          minWidth: width,
